<?php
  class Photoupload {
    ...
    public function createThumbnail($directory, $size){
	  ...
	  $this->savePhoto($targetFile, $myThumbnail);
      
    }
	
	public function saveTempPhoto($targetFile) {
		return $this->savePhoto($targetFile, $this->myTempImage);
	}
	
	public function savePhoto($targetFile,$image){
	  $notice = "";
